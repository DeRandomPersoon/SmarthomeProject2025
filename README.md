...
- [ControlBoard.py](ControlBoard.py): Manual controls, schedules, and alarm trigger logic that talk to the Pico over WiFi.
- [SettingsPage.py](SettingsPage.py): Connection setup and testing for serial ports and Pico WiFi IP; saves selections to settings.json.
...
- CSV - Data storage for panel information
